...
string(FIND "${error}" "at trace.export.FoundationFail (app/main.fn:6:5)" foundation_frame)
string(FIND "${error}" "at [native] foundation_fail (app/main.fn:5:1)" export_frame)
string(FIND "${error}" "at [native] foundation_native_round_trip (app/main.fn:3:1)" import_frame)
string(FIND "${error}" "at trace.export.main (app/main.fn:10:5)" main_frame)
