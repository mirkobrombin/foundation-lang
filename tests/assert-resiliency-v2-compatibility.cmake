if(NOT DEFINED COMPILER OR NOT DEFINED GO_EXECUTABLE OR NOT DEFINED GIT_EXECUTABLE OR
   ...
   NOT DEFINED NATIVE OR NOT DEFINED WORK)
    message(FATAL_ERROR "resiliency compatibility assertion is missing an input")
endif()
...
execute_process(
    COMMAND "${GIT_EXECUTABLE}" -C "${V2_SOURCE}" diff --quiet --
        core/resiliency app/web go.mod
    RESULT_VARIABLE dirty_result
)
if(NOT dirty_result EQUAL 0)
    message(FATAL_ERROR "Foundation v2 resiliency baseline has local changes")
endif()
...
execute_process(
    COMMAND "${COMPILER}" run "${FOUNDATION_RUNNER}" --native "${NATIVE}"
...
if(NOT foundation_result EQUAL 0)
    message(FATAL_ERROR
        "Foundation resiliency fixture failed:\n${foundation_output}${foundation_error}")
endif()
...
if(NOT go_result EQUAL 0)
    message(FATAL_ERROR "Foundation v2 resiliency fixture failed:\n${go_error}")
endif()

if(NOT foundation_output STREQUAL go_output)
    message(FATAL_ERROR
        "Foundation resiliency output differs from v2:\n"
        "Foundation:\n${foundation_output}v2:\n${go_output}")
endif()

message(STATUS "Foundation resiliency matches the v2 contract at ${v2_revision}")
