if(NOT DEFINED COMPILER OR NOT DEFINED GO_EXECUTABLE OR NOT DEFINED GIT_EXECUTABLE OR
   ...
   NOT DEFINED WORK)
    message(FATAL_ERROR "adapters compatibility assertion is missing an input")
endif()
...
execute_process(
    COMMAND "${GIT_EXECUTABLE}" -C "${V2_SOURCE}" diff --quiet -- core/adapters go.mod
    RESULT_VARIABLE dirty_result
)
if(NOT dirty_result EQUAL 0)
    message(FATAL_ERROR "Foundation v2 adapters baseline has local changes")
endif()
...
if(NOT foundation_result EQUAL 0)
    message(FATAL_ERROR
        "Foundation adapters fixture failed:\n${foundation_output}${foundation_error}")
endif()
...
if(NOT go_result EQUAL 0)
    message(FATAL_ERROR "Foundation v2 adapters fixture failed:\n${go_error}")
endif()

if(NOT foundation_output STREQUAL go_output)
    message(FATAL_ERROR
        "Foundation adapters output differs from v2:\n"
        "Foundation:\n${foundation_output}v2:\n${go_output}")
endif()

message(STATUS "Foundation adapters matches the v2 contract at ${v2_revision}")
