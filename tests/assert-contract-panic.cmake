...
string(FIND "${error}" "at trace.failure.Crashing.Fail (lib/lib.fn:9:9)" method_frame)
string(FIND "${error}" "at trace.app.run (app/main.fn:6:11)" contract_frame)
string(FIND "${error}" "at trace.app.main (app/main.fn:11:5)" main_frame)
