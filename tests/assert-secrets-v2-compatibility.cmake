if(NOT DEFINED COMPILER OR NOT DEFINED GO_EXECUTABLE OR NOT DEFINED GIT_EXECUTABLE OR
   ...
   NOT DEFINED WORK)
    message(FATAL_ERROR "secrets compatibility assertion is missing an input")
endif()
...
execute_process(
    COMMAND "${GIT_EXECUTABLE}" -C "${V2_SOURCE}" diff --quiet -- core/secrets go.mod
    RESULT_VARIABLE dirty_result
)
if(NOT dirty_result EQUAL 0)
    message(FATAL_ERROR "Foundation v2 secrets baseline has local changes")
endif()
...
execute_process(
    COMMAND "${CMAKE_COMMAND}" -E env
        FOUNDATION_SECRET_TEST=environment-value
        "${COMPILER}" run "${FOUNDATION_RUNNER}"
...
if(NOT go_result EQUAL 0)
    message(FATAL_ERROR "Foundation v2 secrets fixture failed:\n${go_error}")
endif()

if(NOT foundation_output STREQUAL go_output)
    message(FATAL_ERROR
        "Foundation secrets output differs from v2:\n"
        "Foundation:\n${foundation_output}v2:\n${go_output}")
endif()

message(STATUS "Foundation secrets matches the v2 contract at ${v2_revision}")
