if(NOT DEFINED COMPILER OR NOT DEFINED GO_EXECUTABLE OR NOT DEFINED GIT_EXECUTABLE OR
   ...
   NOT DEFINED WORK)
    message(FATAL_ERROR "caching compatibility assertion is missing an input")
endif()
...
execute_process(
    COMMAND "${GIT_EXECUTABLE}" -C "${V2_SOURCE}" diff --quiet -- core/caching go.mod
    RESULT_VARIABLE dirty_result
)
if(NOT dirty_result EQUAL 0)
    message(FATAL_ERROR "Foundation v2 caching baseline has local changes")
endif()
...
if(NOT go_result EQUAL 0)
    message(FATAL_ERROR "Foundation v2 caching fixture failed:\n${go_error}")
endif()

if(NOT foundation_output STREQUAL go_output)
    message(FATAL_ERROR
        "Foundation caching output differs from v2:\n"
        "Foundation:\n${foundation_output}v2:\n${go_output}")
endif()

message(STATUS "Foundation caching matches the v2 contract at ${v2_revision}")
