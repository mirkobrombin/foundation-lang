if(NOT DEFINED COMPILER OR NOT DEFINED GO_EXECUTABLE OR NOT DEFINED GIT_EXECUTABLE OR
   ...
   NOT DEFINED WORK)
    message(FATAL_ERROR "auth compatibility assertion is missing an input")
endif()
...
execute_process(
    COMMAND "${GIT_EXECUTABLE}" -C "${V2_SOURCE}" diff --quiet -- core/auth go.mod
    RESULT_VARIABLE dirty_result
)
if(NOT dirty_result EQUAL 0)
    message(FATAL_ERROR "Foundation v2 auth baseline has local changes")
endif()
...
if(NOT go_result EQUAL 0)
    message(FATAL_ERROR "Foundation v2 auth fixture failed:\n${go_error}")
endif()

if(NOT foundation_output STREQUAL go_output)
    message(FATAL_ERROR
        "Foundation auth output differs from v2:\nFoundation:\n${foundation_output}v2:\n${go_output}")
endif()

message(STATUS "Foundation auth matches the v2 contract at ${v2_revision}")
