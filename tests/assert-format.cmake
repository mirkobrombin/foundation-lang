...
file(COPY_FILE "${SOURCE}" "${WORK}/main.fdn" ONLY_IF_DIFFERENT)
execute_process(
...
file(READ "${WORK}/main.fdn" written)
...
file(COPY_FILE "${INVALID}" "${WORK}/invalid.fdn" ONLY_IF_DIFFERENT)
file(READ "${WORK}/invalid.fdn" invalid_original)
execute_process(
    COMMAND "${COMPILER}" format --write "${WORK}/invalid.fdn"
    RESULT_VARIABLE invalid_status
    OUTPUT_VARIABLE invalid_output
    ERROR_VARIABLE invalid_errors
)
file(READ "${WORK}/invalid.fdn" invalid_written)
...
file(READ "${WORK}/main.fdn" project_valid_after)
...
file(REMOVE "${WORK}/invalid.fdn")
file(COPY_FILE "${SOURCE}" "${WORK}/main.fdn" ONLY_IF_DIFFERENT)
file(CREATE_LINK "${SOURCE}" "${WORK}/z-link.fdn" SYMBOLIC RESULT link_result)
if(link_result STREQUAL "0")
    ...
    file(READ "${WORK}/main.fdn" link_project_after)
    ...
    file(REMOVE "${WORK}/z-link.fdn")
endif()

file(REMOVE "${WORK}/main.fdn")
file(COPY_FILE "${SOURCE}" "${WORK}/z.fdn" ONLY_IF_DIFFERENT)
file(COPY_FILE "${SOURCE}" "${WORK}/a.fdn" ONLY_IF_DIFFERENT)
execute_process(
    COMMAND "${COMPILER}" format --check "${WORK}"
