...
I may use generative AI tools as assistants while working on Foundation. Non-trivial assisted commits disclose the tool, model, and scope of the work.

AI tools may assist with code comments, documentation, repetitive code, and issue triage. I make project decisions and review every assisted change before it is merged.
