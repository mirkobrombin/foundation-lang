...
expressions, branches, loops, semantic resolution, typed FIR, and checked i32 operations. Each
added construct must serve the stage-1 compiler or an already accepted language invariant.
