...
const staticCompletions = [
    ...
    { label: "web.Response", kind: "Struct", detail: "owned HTTP response with binary body" },
    { label: "web.Compressor", kind: "Interface", detail: "binary response compression provider" },
    { label: "web.CompressionMiddleware", kind: "Struct", detail: "explicit binary-safe response compression middleware" },
    { label: "web.CompressionError", kind: "Enum", detail: "compression provider failure" },
    ...
    { label: "logger.Trace", kind: "Struct", detail: "explicit trace and span identity" },
    { label: "logger.Entry", kind: "Struct", detail: "owned transferable structured log event" },
    { label: "logger.RenderError", kind: "Enum", detail: "time, field, or JSON rendering failure" },
    { label: "logger.Sink", kind: "Interface", detail: "typed fallible log output contract" },
    { label: "logger.ConsoleSink", kind: "Struct", detail: "compact JSON standard-output sink" },
    { label: "logger.CLEFSink", kind: "Struct", detail: "CLEF standard-output sink" },
    { label: "logger.Logger", kind: "Struct", detail: "threshold-filtered logger with persistent owned fields" },
    { label: "logger.Pipeline", kind: "Struct", detail: "synchronous logger with one typed sink" },
    { label: "logger.AsyncError", kind: "Enum", detail: "invalid asynchronous sink configuration" },
    { label: "logger.Publisher", kind: "Struct", detail: "owned producer for a bounded log queue" },
    { label: "logger.Async", kind: "Struct", detail: "bounded sink worker with draining shutdown" },
    ...
    },
    {
        label: "fs.WatchNext",
        kind: "Function",
        detail: "task WatchNext(path String, intervalMilliseconds u64) Result<fs.Event, fs.Error>",
        documentation: "Wait for one created, modified, or removed filesystem event without blocking the executor.",
        insertText: "fs.WatchNext(${1:path}, ${2:intervalMilliseconds})"
    },
    {
        label: "fs.OpenDir",
        kind: "Function",
    ...
    { label: "fs.EventKind", kind: "Enum", detail: "created, modified, or removed filesystem event" },
    { label: "fs.Event", kind: "Struct", detail: "observed filesystem event and path" },
    ...
    { label: "logger.NewEntry", kind: "Function", detail: "fn NewEntry(level logger.Level, timestamp time.Instant, $message String, $fields own collections.List<logger.Field>, $trace logger.Trace) own logger.Entry", insertText: "logger.NewEntry(${1:level}, ${2:timestamp}, \$${3:message}, \$${4:fields}, \$${5:trace})" },
    { label: "logger.RenderText", kind: "Function", detail: "fn RenderText($entry own logger.Entry) String", insertText: "logger.RenderText(\$${1:entry})" },
    { label: "logger.RenderJSON", kind: "Function", detail: "fn RenderJSON($entry own logger.Entry) Result<String, logger.RenderError>", insertText: "logger.RenderJSON(\$${1:entry})" },
    { label: "logger.RenderCLEF", kind: "Function", detail: "fn RenderCLEF($entry own logger.Entry) Result<String, logger.RenderError>", insertText: "logger.RenderCLEF(\$${1:entry})" },
    { label: "logger.NewConsoleSink", kind: "Function", detail: "fn NewConsoleSink() own logger.ConsoleSink", insertText: "logger.NewConsoleSink()" },
    { label: "logger.NewCLEFSink", kind: "Function", detail: "fn NewCLEFSink() own logger.CLEFSink", insertText: "logger.NewCLEFSink()" },
    { label: "logger.NewPipeline", kind: "Function", detail: "fn NewPipeline<E>($sink own logger.Sink<E>, minimum logger.Level) own logger.Pipeline<E>", insertText: "logger.NewPipeline<${1:Error}>(\$${2:sink}, ${3:minimum})" },
    { label: "logger.NewAsync", kind: "Function", detail: "fn NewAsync<E>($sink own logger.Sink<E>, capacity u64) Result<own logger.Async<E>, logger.AsyncError>", insertText: "logger.NewAsync<${1:Error}>(\$${2:sink}, ${3:capacity})" },
    { label: "logger.NewPublisher", kind: "Function", detail: "fn NewPublisher<E>(async logger.Async<E>) logger.Publisher", insertText: "logger.NewPublisher(${1:async})" },
    { label: "logger.Publish", kind: "Function", detail: "task Publish($publisher logger.Publisher, $entry own logger.Entry) Result<void, ChannelError>", insertText: "logger.Publish(\$${1:publisher}, \$${2:entry})" },
    { label: "logger.Shutdown", kind: "Function", detail: "fn Shutdown<E>($async own logger.Async<E>) own collections.List<E>", insertText: "logger.Shutdown<${1:Error}>(\$${2:async})" },
    { label: "logger.Cancel", kind: "Function", detail: "fn Cancel<E>($async own logger.Async<E>) void", insertText: "logger.Cancel<${1:Error}>(\$${2:async})" },
    ...
    { label: "logger.Logger.BindTrace", kind: "Method", detail: "fn BindTrace(&self, $trace logger.Trace) void", insertText: "BindTrace(\$${1:trace})" },
    { label: "logger.Logger.ClearTrace", kind: "Method", detail: "fn ClearTrace(&self) void", insertText: "ClearTrace()" },
    { label: "logger.Logger.Prepare", kind: "Method", detail: "fn Prepare(&self, level logger.Level, message String, $fields own collections.List<logger.Field>) Option<own logger.Entry>", insertText: "Prepare(${1:level}, ${2:message}, \$${3:fields})" },
    { label: "logger.Logger.PrepareAt", kind: "Method", detail: "fn PrepareAt(&self, level logger.Level, timestamp time.Instant, message String, $fields own collections.List<logger.Field>) Option<own logger.Entry>", insertText: "PrepareAt(${1:level}, ${2:timestamp}, ${3:message}, \$${4:fields})" },
    ...
    { label: "logger.ConsoleSink.Write", kind: "Method", detail: "fn Write(&self, $entry own logger.Entry) Result<void, logger.RenderError>", insertText: "Write(\$${1:entry})" },
    { label: "logger.CLEFSink.Write", kind: "Method", detail: "fn Write(&self, $entry own logger.Entry) Result<void, logger.RenderError>", insertText: "Write(\$${1:entry})" },
    { label: "logger.Pipeline.SetLevel", kind: "Method", detail: "fn SetLevel(&self, level logger.Level) void", insertText: "SetLevel(${1:level})" },
    { label: "logger.Pipeline.Bind", kind: "Method", detail: "fn Bind(&self, $field logger.Field) void", insertText: "Bind(\$${1:field})" },
    { label: "logger.Pipeline.BindTrace", kind: "Method", detail: "fn BindTrace(&self, $trace logger.Trace) void", insertText: "BindTrace(\$${1:trace})" },
    { label: "logger.Pipeline.ClearTrace", kind: "Method", detail: "fn ClearTrace(&self) void", insertText: "ClearTrace()" },
    { label: "logger.Pipeline.Log", kind: "Method", detail: "fn Log(&self, level logger.Level, message String, $fields own collections.List<logger.Field>) Result<bool, E>", insertText: "Log(${1:level}, ${2:message}, \$${3:fields})" },
    { label: "logger.Pipeline.Debug", kind: "Method", detail: "fn Debug(&self, message String, $fields own collections.List<logger.Field>) Result<bool, E>", insertText: "Debug(${1:message}, \$${2:fields})" },
    { label: "logger.Pipeline.Info", kind: "Method", detail: "fn Info(&self, message String, $fields own collections.List<logger.Field>) Result<bool, E>", insertText: "Info(${1:message}, \$${2:fields})" },
    { label: "logger.Pipeline.Warn", kind: "Method", detail: "fn Warn(&self, message String, $fields own collections.List<logger.Field>) Result<bool, E>", insertText: "Warn(${1:message}, \$${2:fields})" },
    { label: "logger.Pipeline.Error", kind: "Method", detail: "fn Error(&self, message String, $fields own collections.List<logger.Field>) Result<bool, E>", insertText: "Error(${1:message}, \$${2:fields})" },
    { label: "logger.Publisher.Clone", kind: "Method", detail: "fn Clone(self) logger.Publisher", insertText: "Clone()" },
