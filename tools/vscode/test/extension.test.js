...
test("grammar and completions track compiler keywords", () => {
    ...
    for (const standard of [
        ...
        "time.MonotonicInstant.Nanoseconds",
        ...
        "metrics.NewHistogram", "metrics.NewTimer", "metrics.Counter.Inc", "metrics.Counter.Add",
        "metrics.Counter.Value", "metrics.Gauge.Set", "metrics.Gauge.Inc", "metrics.Gauge.Dec",
        "metrics.Gauge.Add", "metrics.Gauge.Sub", "metrics.Gauge.Value",
        "metrics.Histogram.Observe", "metrics.Histogram.Snapshot", "metrics.Timer.Start",
        "metrics.Timing.Stop",
        "foundation.httpx", "httpx.RequestError", "httpx.ClientError", "httpx.NetworkError",
        "httpx.BodyReadError", "httpx.BodyPart", "httpx.BodyReadOutcome",
        "httpx.RegistrationError",
        "httpx.Header", "httpx.Request", "httpx.Response", "httpx.StreamingResponse",
        "httpx.Transport", "httpx.ResponseBody", "httpx.StreamingTransport",
        ...
        "httpx.Response.TextBody", "httpx.ResponseBody.Read", "httpx.StreamingResponse.Header",
        "httpx.StreamingTransport.Send",
        ...
        "httpx.VHostMux.RemoveVirtualHost", "httpx.VHostMux.Hosts",
        "httpx.VHostMux.SetFallback", "httpx.VHostMux.ClearFallback",
        "httpx.VHostMux.Dispatch",
        ...
        "resiliency.RetryOptions", "resiliency.StatefulRetryOutcome",
        "resiliency.Retry", "resiliency.RetryStateful",
